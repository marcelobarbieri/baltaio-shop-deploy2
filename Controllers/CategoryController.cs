...
public class CategoryController : ControllerBase
{
    ...
    public async Task<ActionResult<List<Category>>> Post([FromBody] Category model, [FromServices] DataContext context)
    {
        ...
        {
            return BadRequest(new { message = "Não foi possível criar a cateoria" });
        }
    }
    ...
    [Route("{id:int}")]
    [Authorize(Roles = "employee")]
    public async Task<ActionResult<List<Category>>> Put([FromBody] Category model, [FromServices] DataContext context, int id)
    {
